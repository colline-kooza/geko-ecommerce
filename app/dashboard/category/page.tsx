...
//   console.log(categories)
  return (
    <div>
        <Head title={"Create a new category before you create Products"} link={"/dashboard/category/create"}/>
        <div>
        <div className="py-4 bg-white sm:py-16 lg:py-4">
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="max-w-md mx-auto text-center">
            <h2 className="text-2xl font-bold text-gray-900 sm:text-3xl">The Categories</h2>
            <p className="mt-4 text-base font-normal leading-7 text-gray-600">These are the created categories</p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-6 mt-3 lg:mt-5 lg:gap-4 lg:grid-cols-4">
            {
                ...
                <div className="flex items-start justify-between mt-4 space-x-4">
                    ...
                    <div className="text-right flex gap-2 cursor-pointer absolute bottom-0 right-0">
                       <Delete id={cat.id} resourceName="category"/>

                        <Link href={`/dashboard/category/update/${cat.id}`} className="cursor-pointer text-xs font-bold sm:text-sm md:text-base text-green-600 ">
